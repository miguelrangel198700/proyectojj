        ...
        mSpeechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onResults(Bundle bundle) {
                ...
                if (matches != null) {
                    ...
                    if (input.contains("que estoy viendo") || input.contains("ayúdame a ver")
                            ||input.contains("vamos a dar un paseo")
                    ...
                    for (int i = 0; i < parts.length; i++) {
                        ...
                        if(parts[i].equalsIgnoreCase("Hola")){
                            toSpeech.speak("Hola, te puedo ayudar en algo?", TextToSpeech.QUEUE_FLUSH, null);
                        }
